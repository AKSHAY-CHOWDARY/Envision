...
import TypingAnimation from "../skeletons/TypingAnimation.jsx";
		...
		<div className="fixed bottom-6 right-6 z-50">
			{!isOpen ? (
				<button
					...
					className="bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 text-white rounded-full p-4 shadow-lg transition-all duration-300 flex items-center gap-2 hover:p-5"
				>
				...
				<div className="bg-white rounded-lg shadow-2xl w-[380px] h-[550px] flex flex-col">
					<div className="bg-[#160637] p-4 rounded-t-lg flex items-center justify-between">
					...
					>
							...
							>
								...
								{message.sender === "user" && (
									<div className="flex-shrink-0">
										<img
											src={
												userObj.user.hasImage
													? userObj.user.imageUrl
													: `https://dashboard.clerk.com/_next/image?url=https%3A%2F%2Fimg.clerk.com%2FeyJ0eXBlIjoiZGVmYXVsdCIsImlpZCI6Imluc18ycnZ4a1N4Z1A2VVBTTUttRmZGOG40YUFyRW0iLCJyaWQiOiJ1c2VyXzJzNzgwTFRPVzRVR0NJVUNwYUNRTjU0NnlBdSJ9&w=64&q=75`
											}
											alt="User"
						...
						{isTyping && (
							<div className="flex justify-start items-center gap-2">
								<Bot className="h-8 w-8 text-indigo-600" />
								<div className="bg-gray-100 text-gray-800 rounded-xl max-w-[30%] shadow">
									<TypingAnimation/>
								</div>
							</div>
						)}
